...
namespace UniModules.UniCore.EditorTools.Editor.Controls.ReorderableList.Internal
{
    using System;
    ...
    public static class GuiUtility
    {
        ...
        {
            int controlID = UnityEngine.GUIUtility.GetControlID(s_IconButtonHint, FocusType.Passive);
            bool result = false;
            ...
            switch (Event.current.GetTypeForControl(controlID))
            {
                ...
                case EventType.MouseDrag:
                    if (UnityEngine.GUIUtility.hotControl == controlID)
                        Event.current.Use();
                    break;
                ...
                case EventType.Repaint:
                    if (visible)
                    {
                        bool isActive = UnityEngine.GUIUtility.hotControl == controlID && position.Contains(Event.current.mousePosition);
